...
<aside class="app-sidebar">
    <div class="app-sidebar__user">
        <div>
            ...
            <p class="app-sidebar__user-designation">HR Manager</p>
        </div>
    </div>
    <ul class="app-menu">
        <li>
            <a class="app-menu__item active" href="#"><i class="app-menu__icon fa fa-dashboard"></i>
                <span class="app-menu__label">HR Dashboard</span>
            </a>
        </li>
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                <li>
                    <a class="treeview-item" href="#"><i class="icon fa fa-circle-o"></i> HR Users</a>
                </li>
                <li>
